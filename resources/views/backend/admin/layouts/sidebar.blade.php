    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('home')}}">
        ...
        <div class="sidebar-brand-text mx-3">Dr.Kine Admin <sup></sup></div>
      </a>
     ...
     <!-- Heading -->
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('admin/user')}}" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
 ...
 <!-- Divider -->
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('admin/post')}}" style="color: white;">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded"> 
            <a class="collapse-item" href="{{url('visitor/count')}}">Visitors</a>
